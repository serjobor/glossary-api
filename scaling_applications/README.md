...
| ----------- | --------- | --------- | --------- |
| RPS         | 1795      | 2369      | **+30%**  |
| Avg Latency | 11.82 ms  | 9.25 ms   | **−21%**  |
...
| Параметр     | 1 реплика | 4 реплики | Изменение  |
| ------------ | --------- | --------- | ---------- |
| Requests/sec | 1310.25   | 1886.12   | **+43%**   |
| Avg Latency  | 15.20 ms  | 13.45 ms  | **-12%**   |

- Изменился ли потенциал обработки запросов? Увеличение количества реплик Flask-сервиса с 1 до 4 привело к росту пропускной способности примерно на 43%. Средняя задержка уменишилась на 12%.
